...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const phone = "916378586084";
    const text = `Hi, I'm ${formData.name}. ${formData.message}`;
    const url = `https://wa.me/${phone}?text=${encodeURIComponent(text)}`;
    
    window.open(url, "_blank");

    // Clear form fields after opening WhatsApp
    setFormData({
      name: "",
      email: "",
      message: "",
  ...
  return (
    <main
      className="min-h-[calc(80svh-5.03rem)] lg:p-6 p-1 flex flex-col lg:gap-8 gap-4"
      id="contact"
    >
      ...
      <p className="text-lg text-gray-600 text-center">Have a project in mind, a role to fill, or just want to say hi? I'd love to hear from you.</p>

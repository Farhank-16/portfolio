        ...
        {project_data.map((e, index) => (
          ...
          >
            ...
            <section className="p-1 lg:p-2 gap-1 flex flex-col lg:w-2/3 max-w-fit">
              ...
              {/* Project Description */}
              <ul className="list-disc pl-5 flex flex-col gap-2 lg:text-lg text-gray-700 lg:p-2 leading-relaxed">
  {e.description.map((point, idx) => (
    <li key={idx}>{point}</li>
  ))}
</ul>
              {/* Project Buttons */}
              <section className="lg:p-2 flex justify-end gap-4 max-lg:p-3">
                ...
                <a
                  ...
                  className="flex flex-col items-center"
                >
                  <GrDeploy className="bg-white transform hover:-translate-y-1.5 w-11 h-11 rounded-xl duration-500 text-green-600  hover:bg-green-700 p-1.5 hover:text-white" />
                  {/* <span className="text-gray-700 text-sm pt-1.5 flex items-center">
